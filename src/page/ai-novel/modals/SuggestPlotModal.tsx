  ...
  return (
    <Modal
      title={
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ fontSize: 16, fontWeight: 700 }}>🪄 AI 剧情建议与逻辑审核报告</span>
    ...
    >
      <div style={{ padding: '8px 0' }}>
        <div className="modal-tip-banner" style={{
          borderRadius: 8,
          padding: '12px 14px',
          marginBottom: 16
        }}>
          <div style={{ fontWeight: 600, fontSize: 13, color: '#ffd666', marginBottom: 6, display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <div className="modal-tip-banner" style={{
          ...
          <div style={{ fontWeight: 600, color: suggestedPlotData.hasCorrected ? '#fa8c16' : '#52c41a', marginBottom: 4, display: 'flex', alignItems: 'center', gap: 6 }}>
            <span>🔍 逻辑审核官校验报告：</span>
          </div>
        ...
        <div style={{ fontWeight: 600, fontSize: 14, marginBottom: 8, color: '#ffd666' }}>
